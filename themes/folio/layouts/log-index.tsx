...
/**
 * The log's archive (docs/25 §4.2, carried from `console`): the build prefers `<type>-index` when a theme
 * declares it. The menu's word for the archive as the title, one line that says what the ledger holds (how many sessions,
